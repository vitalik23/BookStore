        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubSubTitle = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Interesting printing edition"),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsRemoved = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "CreateDate", "IsRemoved", "Name" },
                values: new object[] { 1L, new DateTime(2021, 3, 15, 14, 52, 6, 558, DateTimeKind.Local).AddTicks(7754), false, "Pushkin" });

            migrationBuilder.InsertData(
                table: "PrintingEditions",
                columns: new[] { "Id", "CreateDate", "Currency", "Description", "IsRemoved", "Price", "Subtitle", "Title", "Type" },
                values: new object[] { 1L, new DateTime(2021, 3, 15, 14, 52, 6, 561, DateTimeKind.Local).AddTicks(6330), 1, "Roman is very interesting", false, 110m, "Printing edition", "Captain's daughter", 1 });
